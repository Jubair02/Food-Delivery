...
const resolveImage = (item) => {
  if (item.image && /^https?:\/\//.test(item.image)) return item.image; // Cloudinary (preferred when online)
  if (imageById[item._id]) return imageById[item._id]; // bundled fallback (offline / API down)
